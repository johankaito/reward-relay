      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="space-y-8">
          ...
          <section id="collection" className="space-y-4">
            ...
            <p className="text-on-surface">We collect personal information to provide you with credit card tracking and churning optimization services. The types of information we collect include:</p>
            ...
            <div className="space-y-4 pl-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Credit Card Portfolio Information</h3>
                <ul className="mt-2 list-disc space-y-1 pl-6 text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Technical Information</h3>
                <ul className="mt-2 list-disc space-y-1 pl-6 text-on-surface">
          ...
          <section id="use" className="space-y-4">
            ...
            <p className="text-on-surface">We use your personal information for the following purposes:</p>
          ...
          <section id="disclosure" className="space-y-4">
            ...
            <p className="text-on-surface">We may share your personal information with:</p>

            <div className="space-y-4 pl-6">
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Service Providers</h3>
                <ul className="mt-2 list-disc space-y-1 pl-6 text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Legal Requirements</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Business Transfers</h3>
                <p className="text-on-surface">
          ...
          <section id="overseas" className="space-y-4">
            ...
            <div className="rounded-xl border border-white/5 bg-[var(--surface)] p-4">
              <h3 className="font-semibold text-on-surface">Current Overseas Locations:</h3>
          ...
          <section id="rights" className="space-y-4">
            ...
            <div className="mt-4 rounded-xl border border-white/5 bg-[var(--surface)] p-4">
              <p className="font-semibold text-on-surface">Office of the Australian Information Commissioner (OAIC):</p>
