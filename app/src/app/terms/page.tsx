      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-on-surface-variant">Last updated: {new Date().toLocaleDateString('en-AU', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
          ...
          {/* Table of Contents */}
          <nav className="rounded-2xl border border-white/5 bg-[var(--surface)] p-6">
          ...
          <section id="description" className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6 text-on-surface">
            ...
            <div className="mt-4 rounded-xl border border-white/5 bg-[var(--surface)] p-4 text-sm text-on-surface-variant">
          ...
          <section id="account" className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Account Creation</h3>
                <ul className="mt-2 list-disc space-y-1 pl-6 text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Account Security</h3>
                <p className="text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Data Accuracy</h3>
                <p className="text-on-surface">
          ...
          <section id="subscription" className="space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-on-surface">Current Status: Free Beta</h3>
              <p className="text-on-surface">
            ...
            <div className="mt-4">
              <h3 className="text-lg font-semibold text-on-surface">Future Pricing</h3>
              <p className="text-on-surface">
            ...
            <div className="mt-4">
              <h3 className="text-lg font-semibold text-on-surface">Cancellation Rights</h3>
              <p className="text-on-surface">
          ...
          <section id="usage" className="space-y-4">
            ...
            <p className="text-on-surface">You agree not to:</p>
            <ul className="list-disc space-y-2 pl-6 text-on-surface">
          ...
          <section id="warranties" className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Service Provided &quot;As Is&quot;</h3>
                <p className="text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">No Warranty of Accuracy</h3>
                <p className="text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Credit Card Product Information</h3>
                <p className="text-on-surface">
          ...
          <section id="termination" className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Termination by You</h3>
                <p className="text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Termination by Us</h3>
                <p className="text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Effect of Termination</h3>
                <p className="text-on-surface">
          ...
          <section id="consumer" className="space-y-4">
            ...
            <div className="mt-4 rounded-xl border border-white/5 bg-[var(--surface)] p-4 text-sm">
              <p className="font-semibold text-on-surface">Consumer Guarantees:</p>
              <p className="mt-2 text-on-surface">
                Services provided by Reward Relay are guaranteed to be:
              </p>
              <ul className="mt-2 list-disc pl-6 text-on-surface">
          ...
          <section id="dispute" className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-on-surface">Informal Resolution</h3>
                <p className="text-on-surface">
              ...
              <div>
                <h3 className="text-lg font-semibold text-on-surface">External Dispute Resolution</h3>
                <p className="text-on-surface">
                  If we cannot resolve your complaint internally, you may refer the matter to:
                </p>
                <div className="mt-2 rounded-xl border border-white/5 bg-[var(--surface)] p-4 text-sm">
                  <p className="font-semibold text-on-surface">Australian Financial Complaints Authority (AFCA)</p>
                  <p className="mt-2 text-on-surface">
          ...
          <section id="contact-terms" className="space-y-4">
            ...
            <div className="rounded-xl border border-white/5 bg-[var(--surface)] p-6">
              <p className="font-semibold text-on-surface">Reward Relay</p>
              <p className="mt-2 text-on-surface">
